			...
			items: [
				...
				},				
				{
					...
					items: [
						{
							xtype: 'component',							
							html: '<p><b>Do you want to test your working website instantly?</b></p> <br> If you create an account on <a href="www.Heroku.com">Heroku</a> your generated website will be deployed and you can test it right away in a seperate browser window. Of course you can still download your source as zip file. Create a Heroku account is free and takes only 2 minutes. Follow the next steps: <br> <ul>   <li>Create an account on <a href="www.Heroku.com">Heroku</a>   </li>   <li>Go to account\'s page and copy paste your API Key to the box below   </li>   <li>Click on set button</li> </ul> <br> If you skip this step you can do it later in account settings menu. <p>It\'s highly recommended to use this feature for convenience! </p>'							
						},						
						{
							xtype: 'container',							
							itemId: 'contHeroku',							
