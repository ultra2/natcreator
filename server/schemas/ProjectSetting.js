...
var GenerationStepSchema = require('../schemas/GenerationStep.js').GenerationStepSchema;

exports.ProjectSettingSchema = new mongoose.Schema({ 
		_id: { type: String }
		...
		,generationSteps: [GenerationStepSchema]
});
