...
exports.PPSetting = require('../schemas/PPSetting').PPSetting;
exports.PPClass = require('../schemas/PPClass').PPClass;
exports.PPData = require('../schemas/PPData').PPData;
exports.PPConfig = require('../schemas/PPConfig').PPConfig;
...
exports.Models = [
	...
	,{name: 'PPSetting', schema: exports.PPSetting, collection: 'PPSetting'}
	,{name: 'PPClass', schema: exports.PPClass, collection: 'PPClass'}
	,{name: 'PPData', schema: exports.PPData, collection: 'PPData'}
	,{name: 'PPConfig', schema: exports.PPConfig, collection: 'PPConfig'}
